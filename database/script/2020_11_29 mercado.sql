...
--
-- Servidor: localhost
-- Tiempo de generación: 30-11-2020 a las 05:40:05
...
--
CREATE DATABASE IF NOT EXISTS `mercado` DEFAULT CHARACTER SET utf8 COLLATE utf8_bin;
USE `mercado`;
...
(2, 2, 'Y funciona correctamente?', '2020-11-26 18:58:00', 7, NULL, NULL, NULL),
(3, 2, 'Es 4g?', '2020-11-27 19:41:18', 4, NULL, NULL, NULL);
