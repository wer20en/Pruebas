...
--
-- Servidor: localhost
-- Tiempo de generación: 16-11-2020 a las 00:04:27
...
CREATE TABLE `productos` (
  ...
  `concesionado` tinyint(1) NOT NULL DEFAULT '0'
...
INSERT INTO `productos` (`id`, `nombre`, `descripcion`, `precio`, `imagen`, `usuario_id`, `categoria_id`, `concesionado`) VALUES
(2, 'Celular', 'Motorola usado', 2000, 'cel.jpg', 6, 1, 0),
(3, 'Tablet', 'Tableta Samsung Galaxy Tab S3 T820 Wifi (negro) Tablet', 2500, 'tableta.jpg', 6, 1, 1),
(4, 'Iphone', 'IPhone usado con estética de 9', 3000, 'iphone.jfif', 7, 1, 0);
